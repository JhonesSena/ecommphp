...
<div id="tabpanel">
    ...
    <div id="tab2">
        ...
        <table cellspacing="0" class="details">
            ...
            echo $jquery->input('pacote',array('name'=>'data[Preco][0][pacote]','class'=>'validateRequired validateNumeric', 'label'=>'Pacote*', 'alt'=>'Pacote','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
            ...
            echo $jquery->input('preco',array('class'=>'validateRequired','name'=>'data[Preco][0][preco]','label'=>'Preço*', 'alt'=>'Preço','id'=>'preco','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
            echo $jquery->input('precoativo',array('type'=>'hidden','value'=>1,'name'=>'data[Preco][0][ativo]','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
            echo $jquery->input('desconto_por_pacote',array('class'=>'validateRequired','name'=>'data[Preco][0][desconto_por_pacote]','label'=>'Desconto Pacote (%)*', 'alt'=>'Desconto Pacote','id'=>'desconto_por_pacote','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
