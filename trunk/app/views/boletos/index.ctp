...
<div class="toolbar">
	<?php echo $html->link(__('Novo Boleto',true), 'add',array('class'=>'linkbutton linkbtn btn_add')); ?>	<a href="#" onclick="location.href='<?php echo $this->webroot;?>/boletos/deleteselected/'+selecionados()" class="linkbutton linkbtn btn_delete">Excluir Vários</a>
...
<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Listar Boletos",true) ?></span></a></li>
    </ul>
    <div id="tab1">
            ...
            <thead> 
               <tr>
				    <th align="center" style="width:20px;padding: 0px 0px 0px 0px"><input type="checkbox" onclick="selecionarTodos()"></th>
                                        ...
                                        <th><?php echo $paginator->sort('nosso_numero');?></th>
                                        <th><?php echo $paginator->sort('emissao');?></th>
                                        <th><?php echo $paginator->sort('status');?></th>
                                        <th><?php echo $paginator->sort('vencimento');?></th>
                                        <th><?php echo $paginator->sort('cedente_id');?></th>
	...
	<tr<?php echo $class;?>>
						...
						<td align="center" style="padding: 0px 0px 0px 0px">
							<input type="checkbox" class="chk" value="<?=$boleto['Boleto']['id']?>">
						</td>
							<td>
			<?php echo $boleto['Boleto']['id']; ?>
		</td>
		<td>
			<?php echo $boleto['Boleto']['numero']; ?>
		</td>
		<td>
			<?php echo $boleto['Boleto']['nosso_numero']; ?>
		</td>
		<td>
			<?php echo $boleto['Boleto']['emissao']; ?>
		</td>
		<td>
			<?php echo $boleto['Boleto']['status']; ?>
		</td>
		<td>
			<?php echo $boleto['Boleto']['vencimento']; ?>
		</td>
		<td>
			<?php echo $boleto['Cedente']['nome']; ?>
		</td>
		<td>
			<?php echo $boleto['Cliente']['nome']; ?>
		</td>
		<td>
			<?php echo $boleto['Boleto']['valor']; ?>
		</td>
	</tr>
<?php endforeach; ?>
