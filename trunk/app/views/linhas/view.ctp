...
<div class="toolbar">
		<?php echo $html->link(__('Editar', true), array('action'=>'edit', $linha['Linha']['id']),array('class'=>'linkbutton linkbtn btn_edit')); ?>
		<?php echo $html->link(__('Deletar', true), array('action'=>'delete', $linha['Linha']['id']), array('class'=>'linkbutton linkbtn btn_delete'), sprintf(__('Deseja realmente apagar?', true), $linha['Linha']['id'])); ?>
		<?php echo $html->link(__('Voltar', true), array('action'=>'index'),array('class'=>'linkbutton linkbtn btn_list')); ?>
</div>

<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Visualizar Linha",true) ?></span></a></li><li><a href="#tab2"><span>Produtos</span></a></li></ul>
    <div id="tab1">
        <table cellspacing="0" class="details">
            		<tr><td class="left"><?php __('Id'); ?></td><td class="right">		
			<?php echo $linha['Linha']['id']; ?></td></tr>		<tr><td class="left"><?php __('Nome'); ?></td><td class="right">		
			<?php echo $linha['Linha']['nome']; ?></td></tr>		<tr><td class="left"><?php __('Ativo'); ?></td><td class="right">		
			<?php if ($linha['Linha']['ativo']==1) echo 'Sim'; else 'Não'; ?></td></tr>
    ...
    <?php
                    $i = 0;
                    foreach ($linha['Produto'] as $produto):
                            $class = null;
                            if ($i++ % 2 == 0) {
                                    $class = ' class="altrow"';
                            }
...
<td><?php if($produto['ativo']==1) echo 'Sim'; else 'Não';?></td>
</tr>
