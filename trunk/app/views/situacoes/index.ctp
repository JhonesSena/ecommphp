...
<div class="toolbar">
	<?php echo $html->link(__('Novo Situacao',true), 'add',array('class'=>'linkbutton linkbtn btn_add')); ?>	<a href="#" onclick="location.href='<?php echo $this->webroot;?>situacoes/deleteselected/'+selecionados()" class="linkbutton linkbtn btn_delete">Excluir Vários</a>
...
<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Listar Situacoes",true) ?></span></a></li>
    </ul>
    <div id="tab1">
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $html->link($situacao['Situacao']['nome'], array('action'=>'view', $situacao['Situacao']['id'])); ?>
		</td>
		<td>
