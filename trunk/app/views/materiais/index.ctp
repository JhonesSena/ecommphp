...
<div class="toolbar">
	<?php echo $html->link(__('Novo Material',true), 'add',array('class'=>'linkbutton linkbtn btn_add')); ?>	<a href="#" onclick="location.href='<?php echo $this->webroot;?>materiais/deleteselected/'+selecionados()" class="linkbutton linkbtn btn_delete">Excluir Vários</a>
...
<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Listar Materiais",true) ?></span></a></li>
    </ul>
    <div id="tab1">
            ...
            <thead> 
               <tr>
				    <th align="center" style="width:20px;padding: 0px 0px 0px 0px"><input type="checkbox" onclick="selecionarTodos()"></th>
                                        ...
                                        <th><?php echo $paginator->sort('receita_id');?></th>
                                    </tr>
            </thead> 
            <tfoot> 
                <tr>
	...
	<tr<?php echo $class;?>>
						...
						<td align="center" style="padding: 0px 0px 0px 0px">
							<input type="checkbox" class="chk" value="<?=$material['Material']['id']?>">
						</td>
							<td>
			<?php echo $material['Material']['id']; ?>
		</td>
		<td>
			<?php echo $html->link($material['Material']['nome'], array('action'=>'view', $material['Material']['id']), array('class'=>'ctxmenu','id'=>$material['Material']['id'])); ?>
		</td>
		<td>
			<?php echo $material['Receita']['nome']; ?>
		</td>
	</tr>
<?php endforeach; ?>
