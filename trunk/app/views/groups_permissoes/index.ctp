...
<div class="toolbar">
	<?php echo $html->link(__('Novo GroupsPermissao',true), 'add',array('class'=>'linkbutton linkbtn btn_add')); ?>	<a href="#" onclick="location.href='<?php echo $this->webroot;?>/groupspermissoes/deleteselected/'+selecionados()" class="linkbutton linkbtn btn_delete">Excluir Vários</a>
...
<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Listar GroupsPermissoes",true) ?></span></a></li>
    </ul>
    <div id="tab1">
        ...
        <table id="myTable" class="tablesorter" cellspacing="1"> 
            <thead> 
               <tr>
				    <th align="center" style="width:20px;padding: 0px 0px 0px 0px"><input type="checkbox" onclick="selecionarTodos()"></th>
                                        ...
                                        <th><?php echo $paginator->sort('permissao_id');?></th>
                                    </tr>
            </thead> 
            <tfoot> 
                <tr>
            ...
            <?php
            $i = 0;
            foreach ($groupsPermissoes as $groupsPermissao):
                    $class = null;
                    if ($i++ % 2 == 0) {
                            $class = ' class="altrow"';
                    }
	...
	<tr<?php echo $class;?>>
						...
						<td align="center" style="padding: 0px 0px 0px 0px">
							<input type="checkbox" class="chk" value="<?=$groupsPermissao['GroupsPermissao']['id']?>">
						</td>
							<td>
			<?php echo $html->link($groupsPermissao['GroupsPermissao']['id'], array('action'=>'view', $groupsPermissao['GroupsPermissao']['id']), array('class'=>'ctxmenu','id'=>$groupsPermissao['GroupsPermissao']['id'])); ?>
		</td>
		<td>
			<?php echo $groupsPermissao['GroupsPermissao']['group_id']; ?>
		</td>
		<td>
			<?php echo $groupsPermissao['GroupsPermissao']['permissao_id']; ?>
		</td>
	</tr>
<?php endforeach; ?>
