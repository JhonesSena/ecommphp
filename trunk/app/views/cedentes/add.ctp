...
<div id="tabpanel">
    ...
    <div id="tab1">
		...
		echo $jquery->input('bloqueto_id',array('error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                ...
                echo $jquery->input('nome',array('name'=>'data[Cliente][nome]','class'=>'validadeRequired', 'label'=>'Nome*','alt'=>'Nome','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		...
		echo $jquery->input('telefone',array('name'=>'data[Cliente][telefone]','class'=>'validadeRequired validateTelefone','alt'=>'Telefone', 'label'=>'Telefone*','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('email',array('name'=>'data[Cliente][email]','class'=>'validadeRequired validateEmail','alt'=>'Email', 'label'=>'Email*', 'error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('logradouro',array('name'=>'data[Cliente][logradouro]','type'=>'textarea','rows'=>3,'class'=>'validadeRequired','alt'=>'Logradouro', 'label'=>'Logradouro*','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('cep',array('name'=>'data[Cliente][cep]','id'=>'cep','class'=>'validateRequired validateCEP','alt'=>'Cep', 'label'=>'Cep*','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('bairro',array('name'=>'data[Cliente][bairro]','class'=>'validadeRequired','alt'=>'Bairro', 'label'=>'Bairro*','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('cidade',array('name'=>'data[Cliente][cidade]','id'=>'cidade','class'=>'validadeRequired','id'=>'cidade','alt'=>'Cidade', 'label'=>'Cidade*','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('estado_id',array('name'=>'data[Cliente][estado_id]','id'=>'estados','class'=>'validadeRequired','alt'=>'Estado', 'label'=>'Estado*', 'empty'=>'Selecione','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
