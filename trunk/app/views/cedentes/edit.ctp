...
<div id="tabpanel">
    ...
    <div id="tab1">
		...
		echo $jquery->input('bloqueto_id',array('error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                ...
                echo $jquery->input('idPessoaJuridica',array('type'=>'hidden','name'=>'data[PessoaJuridica][id]','value'=>$this->data['PessoaJuridica']['id'], 'label'=>'Nome Fantasia*','class'=>'validateRequired','alt'=>'Nome Fantasia','error' => false,'div'=>false,'before' => '<tr class="pessoaJuridica"><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                echo $jquery->input('nome_fantasia',array('name'=>'data[PessoaJuridica][nome_fantasia]','value'=>$this->data['PessoaJuridica']['nome_fantasia'], 'label'=>'Nome Fantasia*','class'=>'validateRequired','alt'=>'Nome Fantasia','error' => false,'div'=>false,'before' => '<tr class="pessoaJuridica"><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                echo $jquery->input('cnpj',array('name'=>'data[PessoaJuridica][cnpj]','value'=>$this->data['PessoaJuridica']['cnpj'],'class'=>'validateRequired validateCNPJ','alt'=>'CNPJ', 'label'=>'CNPJ*','error' => false,'div'=>false,'before' => '<tr class="pessoaJuridica"><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                echo $jquery->input('idPessoaFisica',array('type'=>'hidden','name'=>'data[PessoaFisica][id]','value'=>$this->data['PessoaFisica']['id'],'class'=>'validateRequired validateCPF','alt'=>'CPF', 'label'=>'CPF*','error' => false,'div'=>false,'before' => '<tr class="pessoaFisica"><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                echo $jquery->input('cpf',array('name'=>'data[PessoaFisica][cpf]','value'=>$this->data['PessoaFisica']['cpf'],'class'=>'validateRequired validateCPF','alt'=>'CPF', 'label'=>'CPF*','error' => false,'div'=>false,'before' => '<tr class="pessoaFisica"><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		...
		echo $jquery->input('bairro',array('name'=>'data[Cliente][bairro]','value'=>$this->data['Cliente']['bairro'],'class'=>'validateRequired','alt'=>'Bairro', 'label'=>'Bairro*','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('cidade',array('name'=>'data[Cliente][cidade]','value'=>$this->data['Cliente']['cidade'],'id'=>'cidade','class'=>'validateRequired','id'=>'cidade','alt'=>'Cidade', 'label'=>'Cidade*','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('estado_id',array('name'=>'data[Cliente][estado_id]','value'=>$this->data['Cliente']['estado_id'], 'options'=>$estados,'id'=>'estados','class'=>'validateRequired','alt'=>'Estado', 'label'=>'Estado*', 'empty'=>'Selecione','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
	?>
