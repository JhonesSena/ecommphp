...
<div class="toolbar">
	<?php echo $html->link(__('Novo Venda',true), 'add',array('class'=>'linkbutton linkbtn btn_add')); ?>	<a href="#" onclick="location.href='<?php echo $this->webroot;?>/vendas/deleteselected/'+selecionados()" class="linkbutton linkbtn btn_delete">Excluir Vários</a>
...
<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Listar Vendas",true) ?></span></a></li>
    </ul>
    <div id="tab1">
            ...
            <thead> 
               <tr>
				    <th align="center" style="width:20px;padding: 0px 0px 0px 0px"><input type="checkbox" onclick="selecionarTodos()"></th>
                                        ...
                                        <th><?php echo $paginator->sort('boleto_id');?></th>
                                    </tr>
            </thead> 
            <tfoot> 
                <tr>
	...
	<tr<?php echo $class;?>>
						...
						<td align="center" style="padding: 0px 0px 0px 0px">
							<input type="checkbox" class="chk" value="<?=$venda['Venda']['id']?>">
						</td>
							<td>
			<?php echo $venda['Venda']['id']; ?>
		</td>
		<td>
			<?php echo $venda['Venda']['created']; ?>
		</td>
		<td>
			<?php echo $venda['Pedido']['nome']; ?>
		</td>
		<td>
			<?php echo $venda['Situacao']['nome']; ?>
		</td>
		<td>
			<?php echo $venda['Boleto']['nome']; ?>
		</td>
	</tr>
<?php endforeach; ?>
