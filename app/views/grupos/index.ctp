...
<div class="toolbar">
	<?php echo $html->link(__('Novo Grupo',true), 'add',array('class'=>'linkbutton linkbtn btn_add')); ?>	<a href="#" onclick="location.href='<?php echo $this->webroot;?>/grupos/deleteselected/'+selecionados()" class="linkbutton linkbtn btn_delete">Excluir Vários</a>
...
<div id="tabpanel">
	...
	<tr<?php echo $class;?>>
						...
						<td align="center" style="padding: 0px 0px 0px 0px">
							<input type="checkbox" class="chk" value="<?=$grupo['Grupo']['id']?>">
						</td>
		<td>
			<?php echo $html->link($grupo['Grupo']['nome'], array('action'=>'view', $grupo['Grupo']['id']), array('class'=>'ctxmenu','id'=>$grupo['Grupo']['id'])); ?>
		</td>
		<td>
			<?php if($grupo['Grupo']['ativo']==1) echo "Sim"; else echo "Não"; ?>
		</td>
	</tr>
<?php endforeach; ?>
