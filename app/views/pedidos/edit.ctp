...
<div id="tabpanel">
    <ul>
        <li>
			<a href="#tab1"><span><?php echo __("Editar Pedido",true) ?></span></a>
			</li>
    ...
    <div id="tab1">
		...
		echo $jquery->input('valor_frete',array('error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
