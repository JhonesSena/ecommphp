...
<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Listar SituacaoPedidos",true) ?></span></a></li>
    </ul>
    <div id="tab1">
        ...
        <table id="myTable" class="tablesorter" cellspacing="1"> 
            ...
            <?php
            $i = 0;
            foreach ($situacaoPedidos as $situacaoPedido):
                    $class = null;
                    if ($i++ % 2 == 0) {
                            $class = ' class="altrow"';
                    }
	...
	<tr<?php echo $class;?>>
						...
						<td align="center" style="padding: 0px 0px 0px 0px">
							...
							<td>
			<?php echo $html->link($situacaoPedido['SituacaoPedido']['nome'], array('action'=>'view', $situacaoPedido['SituacaoPedido']['id'])); ?>
		</td>
		<td>
