...
<div class="toolbar">
	<?php echo $html->link(__('Novo GrupoAcesso',true), 'add',array('class'=>'linkbutton linkbtn btn_add')); ?>	<a href="#" onclick="location.href='<?php echo $this->webroot;?>/grupoacessos/deleteselected/'+selecionados()" class="linkbutton linkbtn btn_delete">Excluir Vários</a>
...
<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Listar GrupoAcessos",true) ?></span></a></li>
    </ul>
    <div id="tab1">
        ...
        <table id="myTable" class="tablesorter" cellspacing="1"> 
            ...
            <?php
            $i = 0;
            foreach ($grupoAcessos as $grupoAcesso):
                    $class = null;
                    if ($i++ % 2 == 0) {
                            $class = ' class="altrow"';
                    }
	...
	<tr<?php echo $class;?>>
						...
						<td align="center" style="padding: 0px 0px 0px 0px">
							<input type="checkbox" class="chk" value="<?=$grupoAcesso['GrupoAcesso']['id']?>">
						</td>
							<td>
			<?php echo $grupoAcesso['GrupoAcesso']['id']; ?>
		</td>
		<td>
			<?php echo $html->link($grupoAcesso['GrupoAcesso']['nome'], array('action'=>'view', $grupoAcesso['GrupoAcesso']['id']), array('class'=>'ctxmenu','id'=>$grupoAcesso['GrupoAcesso']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
