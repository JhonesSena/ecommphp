...
<div class="toolbar">
	<?php echo $html->link(__('Novo ClientePedido',true), 'add',array('class'=>'linkbutton linkbtn btn_add')); ?>	<a href="#" onclick="location.href='<?php echo $this->webroot;?>/clientepedidos/deleteselected/'+selecionados()" class="linkbutton linkbtn btn_delete">Excluir Vários</a>
...
<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Listar ClientePedidos",true) ?></span></a></li>
    </ul>
    <div id="tab1">
        ...
        <table id="myTable" class="tablesorter" cellspacing="1"> 
            ...
            <?php
            $i = 0;
            foreach ($clientePedidos as $clientePedido):
                    $class = null;
                    if ($i++ % 2 == 0) {
                            $class = ' class="altrow"';
                    }
	...
	<tr<?php echo $class;?>>
						...
						<td align="center" style="padding: 0px 0px 0px 0px">
							<input type="checkbox" class="chk" value="<?=$clientePedido['ClientePedido']['id']?>">
						</td>
							<td>
			<?php echo $clientePedido['ClientePedido']['id']; ?>
		</td>
		<td>
			<?php echo $clientePedido['Cliente']['nome']; ?>
		</td>
		<td>
			<?php echo $clientePedido['Pedido']['nome']; ?>
		</td>
	</tr>
<?php endforeach; ?>
