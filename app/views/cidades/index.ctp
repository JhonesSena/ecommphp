...
<div class="toolbar">
	<?php echo $html->link(__('Novo Cidade',true), 'add',array('class'=>'linkbutton linkbtn btn_add')); ?>	<a href="#" onclick="location.href='<?php echo $this->webroot;?>/cidades/deleteselected/'+selecionados()" class="linkbutton linkbtn btn_delete">Excluir Vários</a>
...
<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Listar Cidades",true) ?></span></a></li>
    </ul>
    <div id="tab1">
	...
	<tr<?php echo $class;?>>
						...
						<td align="center" style="padding: 0px 0px 0px 0px">
							<input type="checkbox" class="chk" value="<?=$cidade['Cidade']['id']?>">
						</td>
							<td>
		...
		<td>
			<?php echo $html->link($cidade['Cidade']['nome'], array('action'=>'view', $cidade['Cidade']['id']), array('class'=>'ctxmenu','id'=>$cidade['Cidade']['id'])); ?>
		</td>
		<td>
			<?php echo $cidade['Cidade']['ativo']; ?>
		</td>
	</tr>
<?php endforeach; ?>
