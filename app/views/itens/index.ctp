...
<div id="tabpanel">
    <ul>
        <li><a href="#tab1"><span><?php echo __("Listar Itens",true) ?></span></a></li>
    </ul>
    <div id="tab1">
	...
	<tr<?php echo $class;?>>
						...
						<td align="center" style="padding: 0px 0px 0px 0px">
							<input type="checkbox" class="chk" value="<?=$item['Item']['id']?>">
						</td>
							<td>
			<?php echo $html->link($item['Item']['codigo'], array('action'=>'view', $item['Item']['id']), array('class'=>'ctxmenu','id'=>$item['Item']['id'])); ?>
		</td>
		<td>
			<?php echo $item['Produto']['descricao']; ?>
		</td>
		<td>
			<?php echo $item['Item']['titulo']; ?>
		</td>
		<td>
