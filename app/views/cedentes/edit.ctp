...
<div id="tabpanel">
    ...
    <div id="tab1">
		...
		echo $jquery->input('bloqueto_id',array('error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                ...
                echo $jquery->input('idPessoaJuridica',array('type'=>'hidden','name'=>'data[PessoaJuridica][id]','value'=>$this->data['PessoaJuridica']['id'], 'label'=>'Nome Fantasia*','class'=>'validadeRequired','alt'=>'Nome Fantasia','error' => false,'div'=>false,'before' => '<tr class="pessoaJuridica"><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                ...
                echo $jquery->input('idPessoaFisica',array('type'=>'hidden','name'=>'data[PessoaFisica][id]','value'=>$this->data['PessoaFisica']['id'],'class'=>'validadeRequired validateCPF','alt'=>'CPF', 'label'=>'CPF*','error' => false,'div'=>false,'before' => '<tr class="pessoaFisica"><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
