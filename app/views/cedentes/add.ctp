...
<div id="tabpanel">
    ...
    <div id="tab1">
		...
		echo $jquery->input('bloqueto_id',array('class'=>'validateRequired','alt'=>'Bloqueto','label'=>'Bloqueto*', 'empty'=>'Selecione','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                ...
                echo $jquery->input('nome',array('class'=>'validadeRequired', 'label'=>'Nome*','alt'=>'Nome','name'=>'data[Cliente][nome]','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                echo $jquery->input('nome_fantasia',array('class'=>'validadeRequired', 'label'=>'Nome Fantasia*','alt'=>'Nome Fantasia','name'=>'data[PessoaJuridica][nome_fantasia]', 'label'=>'Nome Fantasia*','class'=>'validadeRequired','alt'=>'Nome Fantasia','error' => false,'div'=>false,'before' => '<tr class="pessoaJuridica"><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                echo $jquery->input('cnpj',array('class'=>'validadeRequired','alt'=>'CNPJ','label'=>'CNPJ*','name'=>'data[PessoaJuridica][cnpj]','class'=>'validadeRequired validateCNPJ','alt'=>'CNPJ', 'label'=>'CNPJ*','error' => false,'div'=>false,'before' => '<tr class="pessoaJuridica"><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
                ...
                echo $jquery->input('cpf',array('class'=>'validadeRequired validateCPF','alt'=>'CPF', 'label'=>'CPF*','name'=>'data[PessoaFisica][cpf]','error' => false,'div'=>false,'before' => '<tr class="pessoaFisica"><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		...
		echo $jquery->input('telefone',array('class'=>'validadeRequired validateTelefone','alt'=>'Telefone', 'label'=>'Telefone*','name'=>'data[Cliente][telefone]','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('email',array('class'=>'validadeRequired validateEmail','alt'=>'Email', 'label'=>'Email*','name'=>'data[Cliente][email]', 'error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('logradouro',array('class'=>'validadeRequired','alt'=>'Logradouro', 'label'=>'Logradouro*','name'=>'data[Cliente][logradouro]','type'=>'textarea','rows'=>3,'error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		...
		echo $jquery->input('bairro',array('class'=>'validadeRequired','alt'=>'Bairro', 'label'=>'Bairro*','name'=>'data[Cliente][bairro]','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('cidade',array('class'=>'validadeRequired','id'=>'cidade','alt'=>'Cidade', 'label'=>'Cidade*','name'=>'data[Cliente][cidade]','id'=>'cidade','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
		echo $jquery->input('estado_id',array('class'=>'validadeRequired','alt'=>'Estado', 'label'=>'Estado*','name'=>'data[Cliente][estado_id]','id'=>'estados', 'empty'=>'Selecione','error' => false,'div'=>false,'before' => '<tr><td class="left">','after' => '</td></tr>','between' => '</td><td class="right">'));
